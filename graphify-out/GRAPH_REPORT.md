# Graph Report - /home/sebastian/projects/schafkopf-tracker  (2026-05-04)

## Corpus Check
- Large corpus: 397 files · ~13,753,175 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder, or use --no-semantic to run AST-only.
