...
export default function WizardSessionView({ session, registeredPlayers = [], onBack, onSessionUpdated }) {
  ...
  const handleSubmit = () => {
    ...
    if (editingRound) {
      handleRoundSaved({ ...roundData, id: editingRound.id });
    } else {
